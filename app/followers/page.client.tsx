    ...
    >
      ...
      {isLoading ? (
          ...
          <motion.div {...usersAnimation}>
            {viewMode === 'masonry' && (
              <Masonry
                ...
                itemAs="li"
                role="list"
                aria-label="Lista obserwujących w układzie masonry"
              />
            )}
          ...
          {totalPages > 1 && (
            <motion.div {...paginationAnimation} className="mt-8">
              <UniversalPagination
                ...
                ariaLabel="Przejdź między stronami obserwujących"
              />
            </motion.div>
          )}
        </>
        ...
        <NoResults
          ...
          description="Nie znaleziono obserwujących spełniających kryteria wyszukiwania."
