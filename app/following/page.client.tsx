    ...
    >
      ...
      {isLoading ? (
          ...
          <motion.div {...usersAnimation}>
            {viewMode === 'masonry' && (
              <Masonry
                ...
                itemAs="li"
                role="list"
                aria-label="Lista obserwowanych w układzie masonry"
              />
            )}
          ...
          {totalPages > 1 && (
            <motion.div {...paginationAnimation} className="mt-8">
              <UniversalPagination
                ...
                ariaLabel="Przejdź między stronami obserwowanych"
              />
            </motion.div>
          )}
        </>
        ...
        <NoResults
          ...
          description="Nie znaleziono obserwowanych spełniających kryteria wyszukiwania."
