...
const ShareModal = ({
  ...
  const modalOnOpenChange = onOpenChange ?? internalOnOpenChange;
            ...
            <>
              ...
              <ModalBody className="w-full space-y-4">
                <p className="text-sm text-default-500">
                  Skopiuj link lub udostępnij pytanie w serwisach
                  społecznościowych.
                </p>
