...
export const ReportModal: React.FC<ReportModalProps> = ({
  ...
  const { isActive: isReported, handleClick: handleReportToast } =
    useToastActionCooldown({
      ...
      onSuccessMessage: {
        ...
        description:
          'Dziękujemy za zgłoszenie. Zostanie ono niezwłocznie przeanalizowane.',
    ...
    >
      <ModalContent className="bg-cBgDark-800">
        {(onClose) => (
          <Form
            onSubmit={(e) =>
              void handleSubmit((data) => onSubmit(data, onClose))(e)
            }
          >
